            ...
            <body>
                <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
                    ...
                    <form action="/query" autocomplete="off">
                        <input class="form-control form-control-dark w-100" name="query" placeholder="SQL-Query/Search for name"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <nav class="col-md-2 d-none d-md-block bg-light sidebar" style="top: 45px;position: fixed">
                            <div class="sidebar-sticky">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="?query=SELECT * FROM Cards WHERE type!='Synchro Monster'
                                         AND type!='Fusion Monster' AND type!='Effect Monster' AND type!='Normal Monster'
                                         AND type!='Trap Card' AND type!='Spell Card' ORDER BY type, name ASC">
                                            <span data-feather="layers"/>
                                            Other cards
                                        </a>
                                    </li>
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                            <h2 style="margin-top: 45px;">Query Result</h2>
                                                    ...
                                                    <td>
                                                        <a style="color: black; text-decoration: underline">
                                                            <xsl:attribute name="href">
                                                                ...
                                                                WHERE collection='<xsl:value-of select="@collection"/>'
